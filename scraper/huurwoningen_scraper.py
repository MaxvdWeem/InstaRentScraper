...
async def main_huur(page_num=None):
    if page_num:
        url = f'https://www.huurwoningen.nl/aanbod-huurwoningen/?page={page_num}'
    else:
        url = 'https://www.huurwoningen.nl/aanbod-huurwoningen/'

    headers = {
        "authority": "www.huurwoningen.nl",
        "method": "GET",
        "path": "/aanbod-huurwoningen/",
        "scheme": "https",
        ...
        while True:
            ...
            if elements:
                for ele in elements:
                    ...
                    url = f'https://www.huurwoningen.nl{detail_url}'
